...
public class TimerAndHandlerActivity extends AppCompatActivity{
    ...
    private static final String THIS_TENT_DATA = "TimerAndHandlerActivity";
    ...
    public static void startIntentTastHandler(Context context,String object){
        Intent intent = new Intent(context,TimerAndHandlerActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                TimerAndHandlerActivity.this.finish();
                return true;
            default:
